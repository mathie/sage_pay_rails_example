class NotificationsController < InheritedResources::Base
  ...
  def create
    ...
    render :text => SagePay::Server::TransactionNotificationResponse.new(:status => :error, :status_detail => "An exception occurred: #{e.message}", :redirect_url => payments_url).response
  end
end
